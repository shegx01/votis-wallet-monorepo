package finance.votis.wallet.core.ui.theme
...
// Custom colors for Votis
@Immutable
data class VotisColors(
    val brand: Color,
    val brandDark: Color,
    val greyText: Color,
    val surface: Color,
...
// Light theme colors
val lightVotisColors =
    VotisColors(
        brand = VotisBrand,
        brandDark = VotisBrandDark,
        greyText = GreyText,
        surface = White,
        onSurface = Black,
    )
...
// Extension properties to access custom colors and dimensions
val MaterialTheme.votisColors: VotisColors
    @Composable
    @ReadOnlyComposable
    get() = LocalVotisColors.current
...
fun AppTheme(
    ...
    val votisColors =
        when {
            darkTheme -> darkVotisColors
            else -> lightVotisColors
        }

    androidx.compose.runtime.CompositionLocalProvider(
        LocalVotisColors provides votisColors,
    ) {
        MaterialTheme(
